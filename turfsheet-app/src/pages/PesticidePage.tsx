...
export default function PesticidePage() {
    ...
    const handleSave = async (formData: any) => {
        try {
            setError(null);
            console.log('Inserting pesticide application:', formData);
    ...
    return (
        <div className="space-y-12 h-full flex flex-col">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-border-color">
                <div>
                    ...
                    <p className="text-text-secondary text-sm font-sans">
                        Track chemical applications for regulatory compliance and agronomic records.
                    </p>
                </div>
                <button
            ...
            {/* List Content */}
            <div className="flex-1 overflow-y-auto custom-scrollbar -mt-8">
                {loading && (
            ...
            >
                {selectedApplication && (
                    <div className="space-y-6 font-sans">
                        ...
                        {/* Target & REI */}
                        {(selectedApplication.target_pest || selectedApplication.rei_hours) && (
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                {selectedApplication.rei_hours !== undefined && selectedApplication.rei_hours !== null && (
                                    <div>
                                        <label className={detailLabelClasses}>REI (Re-Entry Interval)</label>
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                    ...
                                    {selectedApplication.temperature && (
                                        <div>
                                            ...
                                            <p className="text-sm text-text-primary">{selectedApplication.temperature}</p>
                                        </div>
                                    )}
                                    {selectedApplication.wind_speed && (
                                        <div>
                                            <label className={detailLabelClasses}>Wind Speed</label>
                                            <p className="text-sm text-text-primary">{selectedApplication.wind_speed}</p>
                                        </div>
                                    )}
                                </div>
                            </div>
